---
title: Overview
description: '**llmOS is the Linux of LLMs**. As the first step, it provides free, permissionless access to the state of the art open-source LLMs. By devs, for devs.'
---
