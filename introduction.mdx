...
The first model we serve is [Mistral 7B Instruct model](https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.1) which is on bar with GPT-3.5 on many [benchmarks](https://mistral.ai/news/announcing-mistral-7b/).
